...
public final class TodoFileDirAndModuleComparator
    implements Comparator<NodeDescriptor<?>> {
  public static final TodoFileDirAndModuleComparator INSTANCE =
      new TodoFileDirAndModuleComparator();
  ...
  public int compare(NodeDescriptor obj1, NodeDescriptor obj2) {
    ...
    if (obj1 instanceof ModuleToDoNode && obj2 instanceof ModuleToDoNode) {
      ...
      throw new IllegalArgumentException(obj1.getClass().getName() + "," +
