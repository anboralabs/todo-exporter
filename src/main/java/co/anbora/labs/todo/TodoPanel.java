...
public abstract class TodoPanel extends SimpleToolWindowPanel implements OccurenceNavigator, DataProvider, Disposable {
  ...
  private co.anbora.labs.todo.TodoTreeBuilder setupTreeStructure() {
    co.anbora.labs.todo.TodoTreeBuilder todoTreeBuilder = createTreeBuilder(myTree, myProject);
    Disposer.register(this, todoTreeBuilder);
    co.anbora.labs.todo.TodoTreeStructure structure = todoTreeBuilder.getTodoTreeStructure();
    StructureTreeModel<TodoTreeStructure> structureTreeModel = new StructureTreeModel<>(structure, co.anbora.labs.todo.TodoTreeBuilder.NODE_DESCRIPTOR_COMPARATOR, myProject);
  ...
  protected abstract co.anbora.labs.todo.TodoTreeBuilder createTreeBuilder(JTree tree, Project project);
  ...
  protected DefaultActionGroup createGroupByActionGroup() {
    ...
    return (DefaultActionGroup) actionManager.getAction("TodoExporterViewGroupByGroup");
  }
