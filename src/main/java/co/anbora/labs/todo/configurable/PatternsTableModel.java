...
final class PatternsTableModel
  ...
  private final String[] ourColumnNames =
      new String[] {IdeBundle.message("column.todo.patterns.icon"),
  ...
  private final Class[] ourColumnClasses =
      new Class[] {Icon.class, Boolean.class, String.class};

  private final List<TodoPattern> myPatterns;

  PatternsTableModel(List<TodoPattern> patterns) { myPatterns = patterns; }
